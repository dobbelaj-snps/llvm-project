...
LoadInst *LoadInst::cloneImpl() const {
  ...
  // - safe alternative: keep the argument, but map it to nullptr, indicating
  //   that the provenance is unknown.
  if (hasPtrProvenanceOperand())
    Result->setPtrProvenanceOperand(ConstantPointerNull::get(
