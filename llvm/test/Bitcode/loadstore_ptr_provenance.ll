...
define i32 @f(i32* %p, i32* %q, i32* %word, i32** %base) {
  ...
  store i32 42, i32* %p, ptr_provenance i32* unknown_provenance
  ; CHECK-NEXT:   store i32 42, i32* %p, ptr_provenance i32* unknown_provenance
  store i32 43, i32* %q, ptr_provenance i32* unknown_provenance
  ; CHECK-NEXT:   store i32 43, i32* %q, ptr_provenance i32* unknown_provenance
  %r2 = load i32, i32* %p, ptr_provenance i32* unknown_provenance
  ; CHECK-NEXT:   %r2 = load i32, i32* %p, ptr_provenance i32* unknown_provenance
