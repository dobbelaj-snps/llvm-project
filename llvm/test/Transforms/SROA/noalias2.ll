; RUN: opt < %s -sroa -S | FileCheck %s  --check-prefixes=CHECK
...
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %2 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !15)
; CHECK:  %3 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !15)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
...
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp12 = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %l2_fum.sroa.0.0.l2_fum.sroa.0.0.copyload.noalias, i8* %2, i32** null, i64 0, metadata !15), !tbaa !17, !noalias !20
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %4 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !23)
; CHECK:  %5 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !23)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
...
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp20 = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %l3_fum.sroa.5.0.l3_fum.sroa.5.0.copyload.noalias, i8* %5, i32** null, i64 4, metadata !23), !tbaa !25, !noalias !26
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK: ret void
...
; CHECK-NOT: alloca
; CHECK:  %0 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !30)
; CHECK:  %1 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !30)
; CHECK:  %tmp3 = call %struct.FUM* @llvm.noalias.copy.guard.p0s_struct.FUMs.p0i8(%struct.FUM* %a_fum, i8* null, metadata !32, metadata !27)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %cp1.fca.0.[[GEP5:gep[0-9]+]] = getelementptr inbounds %struct.FUM, %struct.FUM* %a_fum, i32 0, i32 0
; CHECK:  %cp1.fca.0.load.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %cp1.fca.0.load, i8* null, i32** %cp1.fca.0.[[GEP5]], i64 0, metadata !27)
; CHECK:  %cp1.fca.1.0.[[GEP6:gep[0-9]+]] = getelementptr inbounds %struct.FUM, %struct.FUM* %a_fum, i32 0, i32 1, i32 0
; CHECK:  %cp1.fca.1.0.load.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %cp1.fca.1.0.load, i8* null, i32** %cp1.fca.1.0.[[GEP6]], i64 0, metadata !27)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %2 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !35)
; CHECK:  %3 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !35)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %cp2.fca.0.load.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %cp1.fca.0.extract, i8* %0, i32** null, i64 0, metadata !30)
; CHECK:  %cp2.fca.1.0.load.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %cp1.fca.1.0.extract, i8* %1, i32** null, i64 4, metadata !30)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp12 = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %cp2.fca.{{.*}}.extract, i8* %2, i32** null, i64 0, metadata !35), !tbaa !17, !noalias !37
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %4 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !38)
; CHECK:  %5 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !38)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %cp3.fca.0.load.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %cp1.fca.0.extract, i8* %0, i32** null, i64 0, metadata !30)
; CHECK:  %cp3.fca.1.0.load.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %cp1.fca.1.0.extract, i8* %1, i32** null, i64 4, metadata !30)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp20 = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %{{cp3|cp2}}.fca.1.0.extract, i8* %5, i32** null, i64 4, metadata !38), !tbaa !25, !noalias !40
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  ret void
...
; CHECK-NOT: alloca
; CHECK:  %0 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !44)
; CHECK:  %1 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !44)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %{{cp1[0-9]*}}.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %{{cp1[0-9]*}}.sroa_as_ptr, i8* null, i32** %2, i64 0, metadata !41)
; CHECK:  %{{cp1[0-9]*}}.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %{{cp1[0-9]*}}.sroa_as_ptr, i8* null, i32** %3, i64 0, metadata !41)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %6 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !46)
; CHECK:  %7 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !46)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK_S:  %cp21.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %4, i8* %0, i32** null, i64 0, metadata !44)
; CHECK_S:  %cp22.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %5, i8* %1, i32** null, i64 4, metadata !44)
; CHECK:  %{{cp2[0-9]+}}.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %4, i8* %0, i32** null, i64 0, metadata !44)
; CHECK:  %{{cp2[0-9]+}}.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %5, i8* %1, i32** null, i64 4, metadata !44)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp12 = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %8, i8* %6, i32** null, i64 0, metadata !46), !tbaa !17, !noalias !48
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %10 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 0, metadata !49)
; CHECK:  %11 = call i8* @llvm.noalias.decl.p0i8.p0p0i32.i64(i32** null, i64 4, metadata !49)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %{{cp3[0-9]*}}.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %4, i8* %0, i32** null, i64 0, metadata !44)
; CHECK:  %{{cp3[0-9]*}}.sroa_as_ptr.noalias = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %5, i8* %1, i32** null, i64 4, metadata !44)
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  %tmp20 = call i32* @llvm.noalias.p0i32.p0i8.p0p0i32.i64(i32* %13, i8* %11, i32** null, i64 4, metadata !49), !tbaa !25, !noalias !51
; CHECK-NOT: llvm.noalias.copy.guard
; CHECK-NOT: llvm.noalias.p
; CHECK-NOT: llvm.noalias.decl
; CHECK:  ret void
