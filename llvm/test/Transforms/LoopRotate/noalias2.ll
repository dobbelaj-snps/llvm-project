...
; CHECK-NEXT: !1 = !{!"clang"}
; CHECK-NEXT: !2 = !{!3}
; CHECK-NEXT: !3 = distinct !{!3, !4, !"test_loop_rotate_XX: pA:pre.rot"}
; CHECK-NEXT: !4 = distinct !{!4, !"test_loop_rotate_XX"}
; CHECK-NEXT: !5 = !{!6, !6, i64 0, i64 4}
; CHECK-NEXT: !6 = !{!7, i64 4, !"any pointer"}
; CHECK-NEXT: !7 = !{!8, i64 1, !"omnipotent char"}
; CHECK-NEXT: !8 = !{!"Simple C/C++ TBAA"}
; CHECK-NEXT: !9 = !{!10}
; CHECK-NEXT: !10 = distinct !{!10, !4, !"test_loop_rotate_XX: pA"}
; CHECK-NEXT: !11 = !{!12}
; CHECK-NEXT: !12 = distinct !{!12, !4, !"test_loop_rotate_XX: pA:h.rot"}
; CHECK-NEXT: !13 = !{!14}
; CHECK-NEXT: !14 = distinct !{!14, !4, !"test_loop_rotate_XX: pA:pre.rot"}
; CHECK-NEXT: !15 = !{!16}
; CHECK-NEXT: !16 = distinct !{!16, !4, !"test_loop_rotate_XX: pA:h.rot"}
; CHECK-NEXT: !17 = !{!18}
; CHECK-NEXT: !18 = distinct !{!18, !4, !"test_loop_rotate_XX: pA:pre.rot"}
; CHECK-NEXT: !19 = !{!20}
; CHECK-NEXT: !20 = distinct !{!20, !4, !"test_loop_rotate_XX: pA:h.rot"}
