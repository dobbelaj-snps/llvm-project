...
// CHECK1-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [[STRUCT_ANON:%.*]], ptr [[TMP17]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP19:%.*]] = load i64, ptr [[TMP18]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load ptr, ptr [[DOTCOPY_FN__ADDR_I]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[DOTPRIVATES__ADDR_I]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    call void [[TMP20]](ptr [[TMP21]], ptr [[DOTFIRSTPRIV_PTR_ADDR_I]]) #3, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[DOTFIRSTPRIV_PTR_ADDR_I]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[TMP17]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP24:%.*]] = load ptr, ptr [[TMP22]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, ptr [[DOTGLOBAL_TID__ADDR_I]], align 4, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP26:%.*]] = call ptr @__kmpc_task_reduction_get_th_data(i32 [[TMP25]], ptr [[TMP24]], ptr [[TMP23]]), !noalias [[META8]]
// CHECK1-NEXT:    [[TMP27:%.*]] = load ptr, ptr [[TMP17]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP28:%.*]] = getelementptr inbounds [[STRUCT_ANON]], ptr [[TMP17]], i32 0, i32 2
// CHECK1-NEXT:    [[TMP29:%.*]] = load ptr, ptr [[TMP28]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    [[TMP30:%.*]] = load ptr, ptr [[TMP22]], align 8, !noalias [[META8]]
// CHECK1-NEXT:    call void @__omp_offloading_{{.*}}_main_l{{[0-9]+}}(ptr [[TMP27]], i64 [[TMP19]], ptr [[TMP29]], ptr [[TMP30]]) #[[ATTR3]], !noalias [[META8]]
