...
// CHECK1-NEXT:    [[TMP59:%.*]] = load i32, i32* [[CONV_I]], align 4, !noalias !6
// CHECK1-NEXT:    [[IDXPROM_I:%.*]] = sext i32 [[TMP59]] to i64
// CHECK1-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds i16, i16* [[CONV2_I]], i64 [[IDXPROM_I]]
// CHECK1-NEXT:    [[TMP60:%.*]] = load i16, i16* [[ARRAYIDX_I]], align 2, !noalias !6
// CHECK1-NEXT:    [[CONV5_I:%.*]] = sext i16 [[TMP60]] to i32
// CHECK1-NEXT:    [[TMP61:%.*]] = load i32, i32* [[CONV_I]], align 4, !noalias !6
// CHECK1-NEXT:    [[ADD6_I:%.*]] = add nsw i32 [[TMP61]], [[CONV5_I]]
// CHECK1-NEXT:    store i32 [[ADD6_I]], i32* [[CONV_I]], align 4, !noalias !6
...
// CHECK2-NEXT:    [[TMP59:%.*]] = load i32, i32* [[CONV_I]], align 4, !noalias !6
// CHECK2-NEXT:    [[IDXPROM_I:%.*]] = sext i32 [[TMP59]] to i64
// CHECK2-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds i16, i16* [[CONV2_I]], i64 [[IDXPROM_I]]
// CHECK2-NEXT:    [[TMP60:%.*]] = load i16, i16* [[ARRAYIDX_I]], align 2, !noalias !6
// CHECK2-NEXT:    [[CONV5_I:%.*]] = sext i16 [[TMP60]] to i32
// CHECK2-NEXT:    [[TMP61:%.*]] = load i32, i32* [[CONV_I]], align 4, !noalias !6
// CHECK2-NEXT:    [[ADD6_I:%.*]] = add nsw i32 [[TMP61]], [[CONV5_I]]
// CHECK2-NEXT:    store i32 [[ADD6_I]], i32* [[CONV_I]], align 4, !noalias !6
