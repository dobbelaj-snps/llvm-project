...
// CHECK-NEXT:    store ptr [[ACC:%.*]], ptr [[ACC_ADDR]], align 8, !noalias !2
// CHECK-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [4 x <4 x float>], ptr [[ARR]], i64 0, i64 0
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[ACC_ADDR]], align 8, !noalias !2
// CHECK-NEXT:    [[TMP1:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP0]], ptr null, ptr [[ACC_ADDR]], i64 0, metadata [[META2:![0-9]+]]), !noalias !2
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[ACC_ADDR]], align 8, !noalias !2
// CHECK-NEXT:    [[TMP3:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP2]], ptr null, ptr [[ACC_ADDR]], i64 0, metadata [[META2]]), !noalias !2
// CHECK-NEXT:    [[TMP4:%.*]] = load <512 x i1>, ptr [[TMP3]], align 64, !noalias !2
...
// CHECK-NEXT:    store <16 x i8> [[TMP6]], ptr [[TMP7]], align 16, !noalias !2
...
// CHECK-NEXT:    store <16 x i8> [[TMP8]], ptr [[TMP9]], align 16, !noalias !2
...
// CHECK-NEXT:    store <16 x i8> [[TMP10]], ptr [[TMP11]], align 16, !noalias !2
...
// CHECK-NEXT:    store <16 x i8> [[TMP12]], ptr [[TMP13]], align 16, !noalias !2
// CHECK-NEXT:    ret void
//
...
// CHECK-BE-NEXT:    store ptr [[ACC:%.*]], ptr [[ACC_ADDR]], align 8, !noalias !2
// CHECK-BE-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [4 x <4 x float>], ptr [[ARR]], i64 0, i64 0
// CHECK-BE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[ACC_ADDR]], align 8, !noalias !2
// CHECK-BE-NEXT:    [[TMP1:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP0]], ptr null, ptr [[ACC_ADDR]], i64 0, metadata [[META2:![0-9]+]]), !noalias !2
// CHECK-BE-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[ACC_ADDR]], align 8, !noalias !2
// CHECK-BE-NEXT:    [[TMP3:%.*]] = call ptr @llvm.noalias.p0.p0.p0.i64(ptr [[TMP2]], ptr null, ptr [[ACC_ADDR]], i64 0, metadata [[META2]]), !noalias !2
// CHECK-BE-NEXT:    [[TMP4:%.*]] = load <512 x i1>, ptr [[TMP3]], align 64, !noalias !2
...
// CHECK-BE-NEXT:    store <16 x i8> [[TMP6]], ptr [[TMP7]], align 16, !noalias !2
...
// CHECK-BE-NEXT:    store <16 x i8> [[TMP8]], ptr [[TMP9]], align 16, !noalias !2
...
// CHECK-BE-NEXT:    store <16 x i8> [[TMP10]], ptr [[TMP11]], align 16, !noalias !2
...
// CHECK-BE-NEXT:    store <16 x i8> [[TMP12]], ptr [[TMP13]], align 16, !noalias !2
// CHECK-BE-NEXT:    ret void
//
